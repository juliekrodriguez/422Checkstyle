...
import julie.structuralMetrics.HOperatorCheck;

public class HOperatorCheckTest {
    
    private int[] requiredTokens = new int[0];
    private HOperatorCheck check = new HOperatorCheck();
    
    @Test
    public void testGetDefaultTokens() {
      assertArrayEquals(defaultTokens, check.getDefaultTokens());
    }

    @Test
    public void testGetAcceptableTokens() {
      assertArrayEquals(acceptableTokens, check.getAcceptableTokens());
    }

    @Test
    public void testGetRequiredTokens() {
      assertArrayEquals(requiredTokens, check.getRequiredTokens());
    }


  private int[] acceptableTokens = { TokenTypes.LCURLY, TokenTypes.LPAREN, 
