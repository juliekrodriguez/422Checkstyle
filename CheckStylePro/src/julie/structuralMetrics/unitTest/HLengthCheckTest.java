...
import julie.structuralMetrics.HLengthCheck;

public class HLengthCheckTest {
    
    private int[] requiredTokens = new int[0];
    private HLengthCheck lc = new HLengthCheck();
    
    @Test
    public void testGetDefaultTokens() {
      assertArrayEquals(defaultTokens, lc.getDefaultTokens());
    }

    @Test
    public void testGetAcceptableTokens() {
      assertArrayEquals(acceptableTokens, lc.getAcceptableTokens());
    }

    @Test
    public void testGetRequiredTokens() {
      assertArrayEquals(requiredTokens, lc.getRequiredTokens());
    }
